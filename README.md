...
- **Icons & Logos**: Icon designs are sourced from [Hugeicons](https://hugeicons.com/), [Streamline](https://www.streamlinehq.com/) (Cyber Color set), [Game Icons](https://game-icons.net/) (under CC BY 3.0), and the Bowser logo SVG from [1000logos.net](https://1000logos.net/bowser-logo/).
- **3D Models**:
